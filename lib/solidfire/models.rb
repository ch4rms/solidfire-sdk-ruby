...
class QoS
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum burst_time:  The length of time burst IOPS is allowed. The value returned is represented in time units of seconds. <br/><b>Note</b>: this value is calculated by the system based on IOPS set for QoS. 
...
class VolumeQOS
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum burst_time: [required] The length of time burst IOPS is allowed. The value returned is represented in time units of seconds. <br/><b>Note</b>: this value is calculated by the system based on IOPS set for QoS. 
        self.burst_time = objectHash["burstTime"]
...
class Volume
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_access_groups: [required] List of volume access groups to which a volume belongs. 
...
class PrepareVirtualSnapshotResult
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum snapshot_id: [required] snapshotID for the prepared VVol snapshot. 
...
class VolumeAccessGroup
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volumes: [required] List of volumes belonging to the volume access group. 
...
class AddVolumesToVolumeAccessGroupRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volumes: [required] List of volumes to add to this volume access group. 
        self.volumes = objectHash["volumes"]
    end
end
...
class VolumeStats
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum actual_iops: [required] Current actual IOPS to the volume in the last 500 milliseconds. 
        ...
        # param Fixnum average_iopsize: [required] Average size in bytes of recent I/O to the volume in the last 500 milliseconds. 
        self.average_iopsize = objectHash["averageIOPSize"]

        # param Fixnum burst_iopscredit: [required] The total number of IOP credits available to the user. When users are not using up to the max IOPS, credits are accrued. 
        self.burst_iopscredit = objectHash["burstIOPSCredit"]

        # param Fixnum client_queue_depth: [required] The number of outstanding read and write operations to the cluster. 
        ...
        # param Fixnum latency_usec: [required] The observed latency time, in microseconds, to complete operations to a volume.<br/> A "0" (zero) value means there is no I/O to the volume. 
        ...
        # param Fixnum read_latency_usec: [required] The average time, in microseconds, to complete read operations. 
        ...
        # param Fixnum total_latency_usec: [required] The average time, in microseconds, to complete read and write operations to a volume. 
        ...
        # param Fixnum volume_access_groups: [required] List of volume access group(s) to which a volume belongs. 
        self.volume_access_groups = objectHash["volumeAccessGroups"]
        ...
        # param Fixnum write_latency_usec: [required] The average time, in microseconds, to complete write operations. 
        ...
        # param Fixnum write_bytes_last_sample: [required] The total number of bytes written to the volume during the last sample period. 
        self.write_bytes_last_sample = objectHash["writeBytesLastSample"]

        # param Fixnum sample_period_msec: [required] The length of the sample period in milliseconds. 
        self.sample_period_msec = objectHash["samplePeriodMSec"]

        # param Fixnum read_bytes_last_sample: [required] The total number of bytes read from the volume during the last sample period. 
        self.read_bytes_last_sample = objectHash["readBytesLastSample"]

        # param Fixnum read_ops_last_sample: [required] The total number of read operations durin gth elast sample period. 
        self.read_ops_last_sample = objectHash["readOpsLastSample"]

        # param Fixnum write_ops_last_sample: [required] The total number of write operations during the last sample period. 
...
class ModifySnapshotRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum snapshot_id: [required] ID of the snapshot. 
        self.snapshot_id = objectHash["snapshotID"]
...
class GetVirtualVolumeUnsharedChunksRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum segment_start: [required] Start Byte offset. 
        self.segment_start = objectHash["segmentStart"]

        # param Fixnum segment_length: [required] Length of the scan segment in bytes. 
        self.segment_length = objectHash["segmentLength"]

        # param Fixnum chunk_size: [required] Number of bytes represented by one bit in the bitmap. 
...
class RemoveBackupTargetRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum backup_target_id: [required] Unique target ID of the target to remove. 
...
class GetDriveHardwareInfoRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum drive_id: [required] DriveID for the drive information requested. DriveIDs can be obtained via the "ListDrives" method. 
        self.drive_id = objectHash["driveID"]
    end
end
...
class Initiator
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_access_groups: [required] A list of volumeAccessGroupIDs to which this initiator belongs. (Array of Integers) 
        self.volume_access_groups = objectHash["volumeAccessGroups"]
...
class RestoreDeletedVolumeRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_id: [required] VolumeID for the deleted volume to restore. 
        self.volume_id = objectHash["volumeID"]
    end
end
...
class RollbackToGroupSnapshotRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum group_snapshot_id: [required] Unique ID of the group snapshot. 
...
class RemoveAccountRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum account_id: [required] AccountID for the account to remove. 
        self.account_id = objectHash["accountID"]
    end
end
...
class ListVirtualVolumeBindingsRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum virtual_volume_binding_ids:  
...
class ModifyGroupSnapshotRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum group_snapshot_id: [required] ID of the snapshot. 
        self.group_snapshot_id = objectHash["groupSnapshotID"]
...
class DeleteSnapshotRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum snapshot_id: [required] The ID of the snapshot to delete. 
        self.snapshot_id = objectHash["snapshotID"]
    end
end
...
class TestDrivesRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum minutes:  The number of minutes to run the test can be specified. 
...
class ModifyVolumeAccessGroupRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum virtual_network_id:  The ID of the SolidFire Virtual Network ID to associate the volume access group with. 
        self.virtual_network_id = objectHash["virtualNetworkID"]

        # param Fixnum virtual_network_tags:  The ID of the VLAN Virtual Network Tag to associate the volume access group with. 
        ...
        # param Fixnum volumes:  List of volumes to initially include in the volume access group. If unspecified, the access group's volumes will not be modified. 
        self.volumes = objectHash["volumes"]
...
class ModifyVirtualNetworkRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum virtual_network_id:  Unique identifier of the virtual network to modify. This is the virtual network ID assigned by the SolidFire cluster. 
        self.virtual_network_id = objectHash["virtualNetworkID"]

        # param Fixnum virtual_network_tag:  Network Tag that identifies the virtual network to modify. 
        self.virtual_network_tag = objectHash["virtualNetworkTag"]
...
class DeleteVolumeAccessGroupRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_access_group_id: [required] The ID of the volume access group to delete. 
        self.volume_access_group_id = objectHash["volumeAccessGroupID"]
    end
end
...
class ListInitiatorsRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum initiators:  A list of initiator IDs to retrieve. You can supply this parameter or the "startInitiatorID" parameter, but not both. 
        self.initiators = objectHash["initiators"]
    end
end
...
class AddVirtualNetworkRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum virtual_network_tag: [required] A unique virtual network (VLAN) tag. Supported values are 1 to 4095 (the number zero (0) is not supported). 
        self.virtual_network_tag = objectHash["virtualNetworkTag"]
...
class ListVolumesForAccountRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum account_id: [required] The ID of the account to list the volumes for. 
        self.account_id = objectHash["accountID"]
...
class FibreChannelSession
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_access_group_id:  The ID of the volume access group to which the initiatorWWPN belongs. If not in a volume access group, the value will be null. 
        self.volume_access_group_id = objectHash["volumeAccessGroupID"]
    end
end
...
class SetDefaultQoSRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum min_iops:  The minimum number of sustained IOPS that are provided by the cluster to a volume. 
        self.min_iops = objectHash["minIOPS"]

        # param Fixnum max_iops:  The maximum number of sustained IOPS that are provided by the cluster to a volume. 
        self.max_iops = objectHash["maxIOPS"]
...
class GetVolumeStatsRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_id: [required] Specifies the volume for which statistics is gathered. 
        self.volume_id = objectHash["volumeID"]
    end
end
...
class CompleteVolumePairingRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_id: [required] The ID of volume on which to complete the pairing process. 
        self.volume_id = objectHash["volumeID"]
    end
end
...
class GetNodeHardwareInfoRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum node_id: [required] The ID of the node for which hardware information is being requested.  Information about a  node is returned if a   node is specified. 
        self.node_id = objectHash["nodeID"]
    end
end
...
class GetVolumeAccessGroupLunAssignmentsRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_access_group_id: [required] Unique volume access group ID used to return information. 
        self.volume_access_group_id = objectHash["volumeAccessGroupID"]
    end
end
...
class VirtualVolumeUnsharedChunkResult
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum chunks: [required] Number of allocated/unshared chunks. 
        self.chunks = objectHash["chunks"]

        # param Fixnum scanned_chunks: [required] Number of chunks scanned. 
        self.scanned_chunks = objectHash["scannedChunks"]

        # param Fixnum chunk_size: [required] Size of each chunk. 
        self.chunk_size = objectHash["chunkSize"]
    end
end
...
class SecureEraseDrivesRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum drives: [required] List of driveIDs to secure erase. 
        self.drives = objectHash["drives"]
    end
end
...
class StartBulkVolumeWriteRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_id: [required] ID of the volume to be written to. 
        self.volume_id = objectHash["volumeID"]
...
class ListVolumesRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum accounts:  If specified, only fetch volumes which belong to the provided accounts. By default, list volumes for all accounts. 
        ...
        # param Fixnum volume_ids:  If specified, only fetch volumes specified in this list. This option cannot be specified if startVolumeID, limit, or accounts option is specified. 
        self.volume_ids = objectHash["volumeIDs"]
    end
end
...
class TestPingRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum attempts:  Specifies the number of times the system should repeat the test ping. Default is 5. 
        ...
        # param Fixnum packet_size:  Specify the number of bytes to send in the ICMP packet sent to each IP. Number be less than the maximum MTU specified in the network configuration. 
        self.packet_size = objectHash["packetSize"]

        # param Fixnum ping_timeout_msec:  Specify the number of milliseconds to wait for each individual ping response. Default is 500ms. 
...
class AddVirtualNetworkResult
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum virtual_network_id: [required] The virtual network ID of the new virtual network. 
        self.virtual_network_id = objectHash["virtualNetworkID"]
    end
end
...
class ModifyVolumePairRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_id: [required] Identification number of the volume to be modified. 
        self.volume_id = objectHash["volumeID"]
...
class ListVolumeAccessGroupsRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum start_volume_access_group_id:  The lowest VolumeAccessGroupID to return. This can be useful for paging. If unspecified, there is no lower limit (implicitly 0). 
...
class ListVolumeAccessGroupsResult
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_access_groups_not_found: [required] A list of volume access groups not found by the system. Present if you used the "volumeAccessGroups" parameter and the system was unable to find one or more volume access groups that you specified. 
...
class StartBulkVolumeReadRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_id: [required] ID of the volume to be read. 
        self.volume_id = objectHash["volumeID"]

        # param str format: [required] The format of the volume data. Can be either: <br/><b>uncompressed</b>: every byte of the volume is returned without any compression. <br/><b>native</b>: opaque data is returned that is smaller and more efficiently stored and written on a subsequent bulk volume write. 
        self.format = objectHash["format"]

        # param Fixnum snapshot_id:  ID of a previously created snapshot used for bulk volume reads. If no ID is entered, a snapshot of the current active volume image is made. 
        self.snapshot_id = objectHash["snapshotID"]
...
class ModifyVolumeRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum total_size:  New size of the volume in bytes. Size is rounded up to the nearest 1MiB size. This parameter can only be used to *increase* the size of a volume. 
        self.total_size = objectHash["totalSize"]
...
class DeleteVolumeRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_id: [required] The ID of the volume to delete. 
        self.volume_id = objectHash["volumeID"]
    end
end
...
class RemoveVolumePairRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_id: [required] ID of the volume on which to stop the replication process. 
        self.volume_id = objectHash["volumeID"]
    end
end
...
class PurgeDeletedVolumeRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_id: [required] The ID of the volume to purge. 
        self.volume_id = objectHash["volumeID"]
    end
end
...
class ListVirtualNetworksRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum virtual_network_ids:  NetworkIDs to include in the list. 
        self.virtual_network_ids = objectHash["virtualNetworkIDs"]

        # param Fixnum virtual_network_tags:  Network Tags to include in the list. 
        self.virtual_network_tags = objectHash["virtualNetworkTags"]
    end
end
...
class BulkVolumeJob
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum snapshot_id: [required] ID of the snapshot if a snapshot is in the source of the bulk volume job. 
        self.snapshot_id = objectHash["snapshotID"]
...
class ModifyAccountRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum account_id: [required] AccountID for the account to modify. 
        self.account_id = objectHash["accountID"]
...
class NodeFibreChannelPortInfoResult
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum node_id: [required] The ID of the Fibre Channel node. 
        self.node_id = objectHash["nodeID"]
...
class CreateVolumeAccessGroupRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volumes:  List of volumes to initially include in the volume access group. If unspecified, the access group will start without any volumes. 
        self.volumes = objectHash["volumes"]
...
class CreateSnapshotRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_id: [required] ID of the volume image from which to copy. 
        self.volume_id = objectHash["volumeID"]

        # param Fixnum snapshot_id:  Unique ID of a snapshot from which the new snapshot is made. The snapshotID passed must be a snapshot on the given volume. If a SnapshotID is not provided, a snapshot is created from the volume's active branch. 
        self.snapshot_id = objectHash["snapshotID"]
...
class RemoveVolumesFromVolumeAccessGroupRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volumes: [required] List of volumes to remove from this volume access group. 
        self.volumes = objectHash["volumes"]
    end
end
...
class AddNodesRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum pending_nodes: [required] List of PendingNodeIDs for the Nodes to be added. You can obtain the list of Pending Nodes via the ListPendingNodes method. 
...
class ListSnapshotsRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_id:  The volume to list snapshots for. If not provided, all snapshots for all volumes are returned. 
        self.volume_id = objectHash["volumeID"]
    end
end
...
class GetAccountEfficiencyRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum account_id: [required] Specifies the volume account for which capacity is computed. 
        self.account_id = objectHash["accountID"]
    end
end
...
class GetVolumeAccessGroupEfficiencyRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_access_group_id: [required] Specifies the volume access group for which capacity is computed. 
        self.volume_access_group_id = objectHash["volumeAccessGroupID"]
    end
end
...
class ListVolumeStatsByVolumeAccessGroupRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_access_groups:  An array of VolumeAccessGroupIDs for which volume activity is returned. If no VolumeAccessGroupID is specified, stats for all volume access groups is returned. 
        self.volume_access_groups = objectHash["volumeAccessGroups"]
    end
end
...
class ListGroupSnapshotsRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_id:  An array of unique volume IDs to query. If this parameter is not specified, all group snapshots on the cluster will be included. 
        self.volume_id = objectHash["volumeID"]
    end
end
...
class GetScheduleRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum schedule_id: [required] Unique ID of the schedule or multiple schedules to display 
        self.schedule_id = objectHash["scheduleID"]
    end
end
...
class RollbackToSnapshotRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum snapshot_id: [required] ID of a previously created snapshot on the given volume. 
        self.snapshot_id = objectHash["snapshotID"]
...
class ModifyClusterFullThresholdRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum stage2_aware_threshold:  Number of nodes worth of capacity remaining on the cluster that triggers a notification. 
        self.stage2_aware_threshold = objectHash["stage2AwareThreshold"]

        # param Fixnum stage3_block_threshold_percent:  Percent below "Error" state to raise a cluster "Warning" alert. 
        self.stage3_block_threshold_percent = objectHash["stage3BlockThresholdPercent"]
...
class KernelCrashDump
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum kernel_crash_dump_min_free_gb: [required] 
        ...
        # param Fixnum kernel_crash_dump_makedumpfile_level: [required] 
...
class HardwareConfig
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum block_drive_size_bytes: [required] 
        ...
        # param Fixnum cpu_cores_enabled: [required] 
        ...
        # param Fixnum num_drives_internal: [required] 
        self.num_drives_internal = objectHash["numDrivesInternal"]

        # param Fixnum slice_drive_size_bytes: [required] 
        ...
        # param Fixnum memory_gb: [required] 
        self.memory_gb = objectHash["memoryGB"]

        # param Fixnum cpu_threads: [required] 
...
class CloneVolumeRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_id: [required] The ID of the volume to clone. 
        self.volume_id = objectHash["volumeID"]
        ...
        # param Fixnum new_size:  New size of the volume, in bytes. May be greater or less than the size of the volume being cloned. If unspecified, the clone's volume size will be the same as the source volume. Size is rounded up to the nearest 1 MiB. 
        self.new_size = objectHash["newSize"]

        # param str access:  Access settings for the new volume. <br/><b>readOnly</b>: Only read operations are allowed. <br/><b>readWrite</b>: Reads and writes are allowed. <br/><b>locked</b>: No reads or writes are allowed. <br/><b>replicationTarget</b>: Identify a volume as the target volume for a paired set of volumes. If the volume is not paired, the access status is locked. <br/><br/> If unspecified, the access settings of the clone will be the same as the source. 
        self.access = objectHash["access"]

        # param Fixnum snapshot_id:  ID of the snapshot to use as the source of the clone. If unspecified, the clone will be created with a snapshot of the active volume. 
        self.snapshot_id = objectHash["snapshotID"]
...
class CopyVolumeRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum volume_id: [required] Source volume to copy. 
        self.volume_id = objectHash["volumeID"]

        # param Fixnum dst_volume_id: [required] Destination volume for the copy. 
        self.dst_volume_id = objectHash["dstVolumeID"]

        # param Fixnum snapshot_id:  Snapshot ID of the source volume to create the copy from. 
        self.snapshot_id = objectHash["snapshotID"]
    end
end
...
class CancelGroupCloneRequest
    ...
    def initialize(objectHash = nil)
        ...
        # param Fixnum group_clone_id: [required] cloneID for the ongoing clone process. 
        self.group_clone_id = objectHash["groupCloneID"]
    end
end
