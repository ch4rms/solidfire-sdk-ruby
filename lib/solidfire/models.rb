...
class FibreChannelPortInfoResult
    ...
    def initialize(objectHash)
        ...
        self.result = FibreChannelPortList.new(objectHash["result"])
    end
end
...
class NetworkConfig
    ...
    def initialize(objectHash)
        ...
        self.physical = PhysicalAdapter.new(objectHash["physical"])
...
class Network
    ...
    def initialize(objectHash)
        ...
        self.bond10_g = NetworkConfig.new(objectHash["Bond10G"])

        # param NetworkConfig bond1_g:  
        self.bond1_g = NetworkConfig.new(objectHash["Bond1G"])

        # param NetworkConfig eth0:  
        self.eth0 = NetworkConfig.new(objectHash["eth0"])

        # param NetworkConfig eth1:  
        self.eth1 = NetworkConfig.new(objectHash["eth1"])

        # param NetworkConfig eth2:  
        self.eth2 = NetworkConfig.new(objectHash["eth2"])

        # param NetworkConfig eth3:  
        self.eth3 = NetworkConfig.new(objectHash["eth3"])

        # param NetworkConfig lo:  
        self.lo = NetworkConfig.new(objectHash["lo"])
    end
end
class Config
    ...
    def initialize(objectHash)
        ...
        self.cluster = ClusterConfig.new(objectHash["cluster"])

        # param Network network: [required] 
        self.network = Network.new(objectHash["network"])
    end
end
class SetConfigResult
    ...
    def initialize(objectHash)
        ...
        self.config = Config.new(objectHash["config"])
    end
end
class StorageContainer
    ...
    def initialize(objectHash)
        ...
        self.storage_container_id = objectHash["storageContainerID"]
...
class Snapshot
    attr_accessor :snapshot_id, :volume_id, :name, :checksum, :enable_remote_replication, :expiration_reason, :expiration_time, :remote_statuses, :status, :snapshot_uuid, :total_size, :group_id, :group_snapshot_uuid, :create_time, :attributes
    ...
    def initialize(objectHash)
        ...
        # param str remote_statuses: [required] Current remote status of the snapshot remoteStatus: Possible values: <br/><b>Present</b>: Snapshot exists on a remote cluster <br/><b>Not Present</b>: Snapshot does not exist on remote cluster <br/><b>Syncing</b>: This is a target cluster and it is currently replicating the snapshot <br/><b>Deleted</b>: This is a target cluster, the snapshot has been deleted, and it still exists on the source. <br/><b>volumePairUUID</b>: universal identifier of the volume pair 
        ...
        self.group_snapshot_uuid = objectHash["groupSnapshotUUID"]
...
class RemoteReplication
    ...
    def initialize(objectHash)
        ...
        self.snapshot_replication = SnapshotReplication.new(objectHash["snapshotReplication"])
...
class VolumePair
    ...
    def initialize(objectHash)
        ...
        self.volume_pair_uuid = objectHash["volumePairUUID"]

        # param RemoteReplication remote_replication: [required] Details about the replication configuration for this volume pair. 
        self.remote_replication = RemoteReplication.new(objectHash["remoteReplication"])
    end
end
class Volume
    ...
    def initialize(objectHash)
        ...
        self.qos = VolumeQOS.new(objectHash["qos"])
...
class VirtualVolumeInfo
    ...
    def initialize(objectHash)
        ...
        self.parent_virtual_volume_id = objectHash["parentVirtualVolumeID"]

        # param UUID storage_container_id: [required] 
        self.storage_container_id = objectHash["storageContainerID"]

        # param StorageContainer storage_container: [required] 
        self.storage_container = StorageContainer.new(objectHash["storageContainer"])
        ...
        self.children = objectHash["children"]

        # param dict metadata: [required] 
        self.metadata = objectHash["metadata"]

        # param Snapshot snapshot_info: [required] 
        self.snapshot_info = Snapshot.new(objectHash["snapshotInfo"])

        # param Volume volume_info: [required] 
        self.volume_info = Volume.new(objectHash["volumeInfo"])
    end
end
class VirtualVolumeHost
    ...
    def initialize(objectHash)
        ...
        self.virtual_volume_host_id = objectHash["virtualVolumeHostID"]

        # param UUID cluster_id: [required] 
        self.cluster_id = objectHash["clusterID"]

        # param UUID visible_protocol_endpoint_ids: [required] 
        self.visible_protocol_endpoint_ids = objectHash["visibleProtocolEndpointIDs"]
...
class VirtualVolumeBinding
    ...
    def initialize(objectHash)
        ...
        self.protocol_endpoint_id = objectHash["protocolEndpointID"]
...
class CreateVirtualVolumeHostRequest
    ...
    def initialize(objectHash)
        ...
        self.calling_virtual_volume_host_id = objectHash["callingVirtualVolumeHostID"]
    end
end
...
class VolumeStats
    ...
    def initialize(objectHash)
        ...
        self.desired_metadata_hosts = MetadataHosts.new(objectHash["desiredMetadataHosts"])
        ...
        self.metadata_hosts = MetadataHosts.new(objectHash["metadataHosts"])
...
class GetVolumeStatsResult
    ...
    def initialize(objectHash)
        ...
        self.volume_stats = VolumeStats.new(objectHash["volumeStats"])
    end
end
...
class VirtualVolumeTask
    ...
    def initialize(objectHash)
        ...
        self.virtual_volume_task_id = objectHash["virtualVolumeTaskID"]

        # param UUID virtualvolume_id: [required] 
        self.virtualvolume_id = objectHash["virtualvolumeID"]

        # param UUID clone_virtual_volume_id: [required] 
        self.clone_virtual_volume_id = objectHash["cloneVirtualVolumeID"]
...
class VirtualVolumeTaskResult
    ...
    def initialize(objectHash)
        ...
        self.task = VirtualVolumeTask.new(objectHash["task"])
    end
end
...
class NodeStateResult
    ...
    def initialize(objectHash)
        ...
        self.result = NodeStateInfo.new(objectHash["result"])
    end
end
...
class GetCurrentClusterAdminResult
    ...
    def initialize(objectHash)
        ...
        self.cluster_admin = ClusterAdmin.new(objectHash["clusterAdmin"])
    end
end
class NewDrive
...
class GetClusterCapacityResult
    ...
    def initialize(objectHash)
        ...
        self.cluster_capacity = ClusterCapacity.new(objectHash["clusterCapacity"])
    end
end
class ModifyAccountRequest
    ...
    def initialize(objectHash)
        ...
        self.initiator_secret = CHAPSecret.new(objectHash["initiatorSecret"])
        ...
        self.target_secret = CHAPSecret.new(objectHash["targetSecret"])
...
class Schedule
    ...
    def initialize(objectHash)
        ...
        self.frequency = Frequency.new(objectHash["frequency"])
        ...
        self.schedule_info = ScheduleInfo.new(objectHash["scheduleInfo"])
...
class GetScheduleResult
    ...
    def initialize(objectHash)
        ...
        self.schedule = Schedule.new(objectHash["schedule"])
    end
end
class QoS
...
class ListNodeStatsResult
    ...
    def initialize(objectHash)
        ...
        self.node_stats = NodeStatsNodes.new(objectHash["nodeStats"])
    end
end
...
class GetClusterHardwareInfoResult
    ...
    def initialize(objectHash)
        ...
        self.cluster_hardware_info = ClusterHardwareInfo.new(objectHash["clusterHardwareInfo"])
    end
end
class DeleteVolumesResult
    ...
    def initialize(objectHash)
        ...
        self.curve = VolumeQOS.new(objectHash["curve"])
    end
end
...
class GetAccountResult
    ...
    def initialize(objectHash)
        ...
        self.account = Account.new(objectHash["account"])
    end
end
...
class ListStorageContainersRequest
    ...
    def initialize(objectHash)
        ...
        self.storage_container_ids = objectHash["storageContainerIDs"]
    end
end
class AddressBlock
...
class GetClusterStatsResult
    ...
    def initialize(objectHash)
        ...
        self.cluster_stats = ClusterStats.new(objectHash["clusterStats"])
    end
end
...
class GetClusterVersionInfoResult
    ...
    def initialize(objectHash)
        ...
        self.software_version_info = SoftwareVersionInfo.new(objectHash["softwareVersionInfo"])
    end
end
...
class ListVirtualVolumesResult
    ...
    def initialize(objectHash)
        ...
        self.next_virtual_volume_id = objectHash["nextVirtualVolumeID"]
    end
end
class Platform
...
class Node
    ...
    def initialize(objectHash)
        ...
        self.platform_info = Platform.new(objectHash["platformInfo"])
...
class GetLdapConfigurationResult
    ...
    def initialize(objectHash)
        ...
        self.ldap_configuration = LdapConfiguration.new(objectHash["ldapConfiguration"])
    end
end
...
class ListVolumeStatsByVirtualVolumeRequest
    ...
    def initialize(objectHash)
        ...
        self.virtual_volume_ids = objectHash["virtualVolumeIDs"]
    end
end
...
class GetVolumeAccessGroupLunAssignmentsResult
    ...
    def initialize(objectHash)
        ...
        self.volume_access_group_lun_assignments = VolumeAccessGroupLunAssignments.new(objectHash["volumeAccessGroupLunAssignments"])
    end
end
...
class GetNodeStatsResult
    ...
    def initialize(objectHash)
        ...
        self.node_stats = NodeStatsInfo.new(objectHash["nodeStats"])
    end
end
...
class ListVirtualVolumesRequest
    ...
    def initialize(objectHash)
        ...
        self.start_virtual_volume_id = objectHash["startVirtualVolumeID"]
...
class ModifyVolumeAccessGroupResult
    ...
    def initialize(objectHash)
        ...
        self.volume_access_group = VolumeAccessGroup.new(objectHash["volumeAccessGroup"])
    end
end
...
class TestConnectEnsembleResult
    ...
    def initialize(objectHash)
        ...
        self.details = TestConnectEnsembleDetails.new(objectHash["details"])
...
class HardwareConfig
    ...
    def initialize(objectHash)
        ...
        self.kernel_crash_dump = KernelCrashDump.new(objectHash["kernelCrashDump"])
        ...
        self.solidfire_defaults = SolidfireDefaults.new(objectHash["solidfireDefaults"])
...
class GetHardwareConfigResult
    ...
    def initialize(objectHash)
        ...
        self.hardware_config = HardwareConfig.new(objectHash["hardwareConfig"])
    end
end
...
class TestConnectMvipResult
    ...
    def initialize(objectHash)
        ...
        self.details = TestConnectMvipDetails.new(objectHash["details"])
...
class ResetDrivesResult
    ...
    def initialize(objectHash)
        ...
        self.details = ResetDrivesDetails.new(objectHash["details"])
    end
end
class ClusterInfo
...
class GetClusterInfoResult
    ...
    def initialize(objectHash)
        ...
        self.cluster_info = ClusterInfo.new(objectHash["clusterInfo"])
    end
end
...
class ListVirtualVolumeTasksRequest
    ...
    def initialize(objectHash)
        ...
        self.virtual_volume_task_ids = objectHash["virtualVolumeTaskIDs"]
    end
end
...
class GetAsyncResultResult
    ...
    def initialize(objectHash)
        ...
        self.result = AsyncResult.new(objectHash["result"])
...
class ListVirtualVolumeHostsRequest
    ...
    def initialize(objectHash)
        ...
        self.virtual_volume_host_ids = objectHash["virtualVolumeHostIDs"]
    end
end
...
class ListProtocolEndpointsRequest
    ...
    def initialize(objectHash)
        ...
        self.protocol_endpoint_ids = objectHash["protocolEndpointIDs"]
    end
end
...
class ISCSISession
    ...
    def initialize(objectHash)
        ...
        self.initiator = Initiator.new(objectHash["initiator"])
...
class GetBackupTargetResult
    ...
    def initialize(objectHash)
        ...
        self.backup_target = BackupTarget.new(objectHash["backupTarget"])
    end
end
...
class GetVirtualVolumeUnsharedChunksRequest
    ...
    def initialize(objectHash)
        ...
        self.base_virtual_volume_id = objectHash["baseVirtualVolumeID"]
...
class PairedCluster
    ...
    def initialize(objectHash)
        ...
        self.cluster_pair_uuid = objectHash["clusterPairUUID"]
...
class NodeDriveHardware
    ...
    def initialize(objectHash)
        ...
        self.result = DrivesHardware.new(objectHash["result"])
    end
end
...
class TestConnectSvipResult
    ...
    def initialize(objectHash)
        ...
        self.details = TestConnectSvipDetails.new(objectHash["details"])
...
class ModifyVolumeResult
    ...
    def initialize(objectHash)
        ...
        self.volume = Volume.new(objectHash["volume"])
    end
end
...
class GetDriveStatsResult
    ...
    def initialize(objectHash)
        ...
        self.drive_stats = DriveStats.new(objectHash["driveStats"])
    end
end
...
class GetDriveHardwareInfoResult
    ...
    def initialize(objectHash)
        ...
        self.drive_hardware_info = DriveHardwareInfo.new(objectHash["driveHardwareInfo"])
    end
end
